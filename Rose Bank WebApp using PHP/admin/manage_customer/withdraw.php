...
<html lang="en">
  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <ul class="list-unstyled components mb-5">
	          <li class="active">
                ...
                <li>
                    <a href="index.php">Manage Customers</a>
                </li>
                <li>
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <h2 class="mb-4">Customer Withdrawal</h2>
...
$email = $fname = $lname = $amount = $balance = "";
...
if($result = mysqli_query($db, $sql)){
	...
	if(mysqli_num_rows($result)>0){
        ...
        if ($bal_2 <  $amnt){
        	...
        	echo "<p> YOU DO NOT HAVE ENOUGH FUNDS </p>";
            ...
            echo "<p>New Account balance for Customer:</p>";
            echo " Mr/Mrs ";
            echo " $fname ";
            echo " $lname ";
            echo " is ";
            ...
            $nquery = "UPDATE customer_users SET balance='$balance' WHERE email='$email'";

            $que = mysqli_query($db, $nquery) or die(mysqli_error($db));
        
                echo "<p> Records for $fname has been updated </p>"; 
 	
	}
    mysqli_free_result($result);
}else{
    echo "<p>Account does not exist choose another one</p>";
}
