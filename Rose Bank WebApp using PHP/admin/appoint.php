...
$sql = "SELECT branch, transaction_type,id_number, first_name, last_name,full_address, mobile_number, email, time_stamp FROM appointment ORDER BY time_stamp ASC";
...
?>    
        <button><a href="appremove.php">Delete Appointment</a></button>
        </div>
		</div>
