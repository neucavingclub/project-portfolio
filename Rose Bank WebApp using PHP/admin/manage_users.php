...
$sql = "SELECT branch, account_type, account_number, balance, idnum, first_name, last_name,full_address, mobile_number, email, created_at FROM customer_users ORDER BY last_name ASC";
