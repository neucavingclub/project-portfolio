...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <h2 class="mb-4">Rose Bank Teller Portal</h2>
        <p>Welcome to Rose Bank Service Portal. This Portal helps the Clerk and the Customer to have the most amazing time and with so many new features added to the system.</p>
        <p>This new system was designed by our Computer Engineering Department to help the customers to have a quality service. Not only does it have new features but one of advanced features.</p>
      </div>
		</div>
