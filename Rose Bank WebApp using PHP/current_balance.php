...
<html lang="en">
  ...
  <body>
        ...
        $balance = $acc_number = $branch = $name = $surname = "";
        $user=$_SESSION['email'];
        $sql = "SELECT balance, account_number, branch, first_name, last_name FROM customer_users WHERE email= '$user'";
...
?> 
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        <h2 class="mb-4">Current Balance </h2>
