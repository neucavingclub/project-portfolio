...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($email_err) && empty($password_err)){
        ...
        $sql = "SELECT id, email, passwordd FROM customer_users WHERE email = ?";
...
<body>
    <form id="frm" class="box"  method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        <h1>Login</h1> 
        <input type="email" name="email" value="<?php echo $email;?>" placeholder="ENTER USERNAME">
        ...
        <h4>Do you have an Account?<a href="">Contact Bank Branch</a><h4> 
      </form>  
    </body>
</html>